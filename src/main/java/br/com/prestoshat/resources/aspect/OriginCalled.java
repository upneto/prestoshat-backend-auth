package br.com.prestoshat.resources.aspect;
...
public class OriginCalled {
	 ...
	 * @throws Throwable
	 */
	@Before("execution(* br.com.prestoshat.controller.api.*.*(..))")
	public void execute() throws Throwable  {
		LOGGER.info("Request {}", this.request.getRequestURI());	    	    
    	String token = this.request.getHeader("PRESTOSHAT-ORIGIN");
